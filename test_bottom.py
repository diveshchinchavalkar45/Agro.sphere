...
try:
    ...
    ws.send(json.dumps({"id": 2, "method": "Runtime.evaluate", "params": {"expression": "window.scrollTo(0, 500)"}}))
    time.sleep(1)
    ...
    while True:
        ...
        if r.get("id") == 3:
            with open("dashboard_bottom_shot.png", "wb") as f:
                f.write(base64.b64decode(r["result"]["data"]))
            break
    print("Saved dashboard_bottom_shot.png")
